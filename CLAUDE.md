...
- Beide ohne `data-y-fuss` → bleiben in der Rück-Ebene, Figur überdeckt sie. **Hindernis** `HINDERNISSE.keller[3]` deckt den ganzen Ketten-Footprint inkl. Vorraum ab → Figur darf den Bereich nicht betreten (für Chain-4-Drop-laufziel siehe Chain 4).
